 ...
 * entity type (Owner), and the second one defines the type of
...
/**
 This line declares a public Java interface called OwnerRepository.
 An interface defines a contract (methods) but does not contain implementations.

 The keyword 'extends' means that OwnerRepository inherits from another interface.
 In Java, interfaces extend other interfaces (they do not use 'implements').

 CrudRepository<Owner, Long> is a Spring Data interface that already defines
 basic CRUD operations (Create, Read, Update, Delete).
 - Owner: the entity type this repository manages.
